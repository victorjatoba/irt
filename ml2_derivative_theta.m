...
%   
    ...
    for j=1:N
        ...
        for i=1:I
            ...
            theta_sum = theta_sum + ( ((U(j, i) - ml2_Pji(theta_j, a_i, b_i, D)) / (ml2_Pji(theta_j, a_i, b_i, D).*ml2_Qji(theta_j, a_i, b_i, D)) ) .* ( (a_i .* D .* exp(L(theta_j,a_i,b_i,D))) / sqrt(1 + exp(L(theta_j,a_i,b_i,D))) ) );
        end
